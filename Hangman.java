/*
    ...
    Instructor: John DeGood
    Student: Saanvi Goyal 
    
    The user plays Hangman with six letter words only. The game starts with 3 lives. The user gets a prompt asking them to guess a letter. 
